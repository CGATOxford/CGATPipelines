...
Sequence read input. These have to be .bam files.

Design_files ("*.design.tsv") are used to specify  variates. The
minimal design file is shown below, where each line is a comparison
between the two tab-separated values.

The naming of the conditions has to be inferred from the ".bam" file
names, which would have been in the format "heart-treated-R1" and are
extracted using 
